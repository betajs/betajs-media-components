/*!
betajs-media-components - v0.0.39 - 2016-12-14
...
return {"video_player_controlbar":" <div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideonactivity ? (css + '-dashboard-hidden') : ''}}\">  <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar {{activitydelta < 2500 || ismobile ? '' : (css + '-progressbar-small')}}\"       onmousedown=\"{{startUpdatePosition(domEvent)}}\"       onmouseup=\"{{stopUpdatePosition(domEvent)}}\"       onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"       onmousemove=\"{{progressUpdatePosition(domEvent)}}\">   <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>   <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\">    <div class=\"{{css}}-progressbar-button\"></div>   </div>  </div>  <div class=\"{{css}}-backbar\"></div>  <div class=\"{{css}}-controlbar\">         <div id=\"submit-video-button\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">             <div class=\"{{css}}-button-inner\">                 {{string('submit-video')}}             </div>         </div>         <div id=\"button-icon-ccw\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{rerecordable}}\"  ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-ccw\"></i>             </div>         </div>   <div id=\"button-icon-play\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">    <div class=\"{{css}}-button-inner\">     <i class=\"{{css}}-icon-play\"></i>    </div>   </div>   <div id=\"button-icon-pause\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-pause\"></i>             </div>   </div>   <div class=\"{{css}}-time-container\">    <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}</div>    <div class=\"{{css}}-time-sep\">/</div>    <div class=\"{{css}}-time-value\" title=\"{{string('total-time')}}\">{{duration_formatted}}</div>   </div>   <div id=\"button-icon-resize-full\" class=\"{{css}}-rightbutton-container\" ba-if=\"{{fullscreen}}\" ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">    <div class=\"{{css}}-button-inner\">     <i class=\"{{css}}-icon-resize-full\"></i>    </div>   </div>   <div id=\"button-stream-label\" class=\"{{css}}-rightbutton-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">    <div class=\"{{css}}-button-inner\">     <span class=\"{{css}}-button-text\">{{currentstream_label}}</span>    </div>   </div>   <div class=\"{{css}}-volumebar\">    <div id=\"button-volume-bar\" class=\"{{css}}-volumebar-inner\"         onmousedown=\"{{startUpdateVolume(domEvent)}}\"                  onmouseup=\"{{stopUpdateVolume(domEvent)}}\"                  onmouseleave=\"{{stopUpdateVolume(domEvent)}}\"                  onmousemove=\"{{progressUpdateVolume(domEvent)}}\">     <div class=\"{{css}}-volumebar-position\" ba-styles=\"{{{width: Math.min(100, Math.round(volume * 100)) + '%'}}}\">         <div class=\"{{css}}-volumebar-button\" title=\"{{string('volume-button')}}\"></div>     </div>    </div>   </div>   <div id=\"button-icon-volume\" class=\"{{css}}-rightbutton-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">    <div class=\"{{css}}-button-inner\">     <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>    </div>   </div>  </div> </div> ","video_player_loader":" <div class=\"{{css}}-loader-container\">     <div id=\"loader-block\" class=\"{{css}}-loader-loader\" title=\"{{string('tooltip')}}\">     </div> </div> ","video_player_message":" <div class=\"{{css}}-message-container\" ba-click=\"click()\">     <div id=\"message-block\" class='{{css}}-message-message'>         {{message}}     </div> </div> ","playbutton":" <div id=\"play-button\" class=\"{{css}}-playbutton-container\" ba-click=\"play()\" title=\"{{string('tooltip')}}\">  <div class=\"{{css}}-playbutton-button\"></div> </div>  <div class=\"{{css}}-rerecord-bar\" ba-if=\"{{rerecordable || submittable}}\">  <div class=\"{{css}}-rerecord-backbar\"></div>  <div class=\"{{css}}-rerecord-frontbar\">         <div class=\"{{css}}-rerecord-button-container\" ba-if=\"{{submittable}}\">             <div id=\"player-submit-button\" class=\"{{css}}-rerecord-button\" onclick=\"{{submit()}}\">                 {{string('submit-video')}}             </div>         </div>         <div class=\"{{css}}-rerecord-button-container\" ba-if=\"{{rerecordable}}\">          <div id=\"player-rerecord-button\" class=\"{{css}}-rerecord-button\" onclick=\"{{rerecord()}}\">           {{string('rerecord')}}          </div>         </div>  </div> </div> ","player":" <div     class=\"{{css}}-container {{css}}-size-{{csssize}} {{iecss}}-{{ie8 ? 'ie8' : 'noie8'}} {{csstheme}}\"     ba-on:mousemove=\"user_activity()\"     ba-on:mousedown=\"user_activity()\"     ba-on:touchstart=\"user_activity()\"     style=\"{{width ? 'width:' + width + ((width + '').match(/^\\d+$/g) ? 'px' : '') + ';' : ''}}{{height ? 'height:' + height + ((height + '').match(/^\\d+$/g) ? 'px' : '') + ';' : ''}}\" >     <video class=\"{{css}}-video\" data-video=\"video\"></video>     <div class=\"{{css}}-overlay\" data-video=\"ad\" style=\"display:none\"></div>     <div class='{{css}}-overlay'>      <ba-{{dyncontrolbar}}       ba-css=\"{{csscontrolbar || css}}\"       ba-template=\"{{tmplcontrolbar}}\"       ba-show=\"{{controlbar_active}}\"       ba-playing=\"{{playing}}\"       ba-event:rerecord=\"rerecord\"       ba-event:submit=\"submit\"       ba-event:play=\"play\"       ba-event:pause=\"pause\"       ba-event:position=\"seek\"       ba-event:volume=\"set_volume\"       ba-event:fullscreen=\"toggle_fullscreen\"       ba-volume=\"{{volume}}\"       ba-duration=\"{{duration}}\"       ba-cached=\"{{buffered}}\"       ba-position=\"{{position}}\"       ba-activitydelta=\"{{activity_delta}}\"       ba-hideoninactivity=\"{{hideoninactivity}}\"       ba-rerecordable=\"{{rerecordable}}\"       ba-submittable=\"{{submittable}}\"       ba-streams=\"{{streams}}\"       ba-currentstream=\"{{=currentstream}}\"       ba-fullscreen=\"{{fullscreensupport && !nofullscreen}}\"       ba-source=\"{{source}}\"   ></ba-{{dyncontrolbar}}>      <ba-{{dynplaybutton}}       ba-css=\"{{cssplaybutton || css}}\"       ba-template=\"{{tmplplaybutton}}\"       ba-show=\"{{playbutton_active}}\"       ba-rerecordable=\"{{rerecordable}}\"       ba-submittable=\"{{submittable}}\"       ba-event:play=\"playbutton_click\"       ba-event:rerecord=\"rerecord\"       ba-event:submit=\"submit\"   ></ba-{{dynplaybutton}}>      <ba-{{dynloader}}       ba-css=\"{{cssloader || css}}\"       ba-template=\"{{tmplloader}}\"       ba-show=\"{{loader_active}}\"   ></ba-{{dynloader}}>      <ba-{{dynmessage}}       ba-css=\"{{cssmessage || css}}\"       ba-template=\"{{tmplmessage}}\"       ba-show=\"{{message_active}}\"       ba-message=\"{{message}}\"       ba-event:click=\"message_click\"   ></ba-{{dynmessage}}>    <ba-{{dyntopmessage}}       ba-css=\"{{csstopmessage || css}}\"       ba-template=\"{{tmpltopmessage}}\"       ba-show=\"{{topmessage}}\"       ba-topmessage=\"{{topmessage}}\"   ></ba-{{dyntopmessage}}>     </div> </div> ","video_player_topmessage":" <div class=\"{{css}}-topmessage-container\">     <div class='{{css}}-topmessage-background'>     </div>     <div id=\"topmessage-message-block\" class='{{css}}-topmessage-message'>         {{topmessage}}     </div> </div> ","video_recorder_chooser":" <div class=\"{{css}}-chooser-container\">   <div class=\"{{css}}-chooser-button-container\">   <div>    <div id=\"chooser-primary-button\" class=\"{{css}}-chooser-primary-button\"         ba-click=\"primary()\"         ba-if=\"{{has_primary}}\">     <input id=\"file-input-opt1\" ba-if=\"{{enable_primary_select && primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\"            capture />     <input id=\"file-input-opt2\" ba-if=\"{{enable_primary_select && !primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\" />     <i class=\"{{css}}-icon-{{primaryrecord ? 'videocam' : 'upload'}}\"></i>     <span>      {{primary_label}}     </span>    </div>   </div>   <div>    <div id=\"chooser-secondary-button\" class=\"{{css}}-chooser-secondary-button\"         ba-click=\"secondary()\"         ba-if=\"{{has_secondary}}\">     <input id=\"file-input-secondary-opt1\" ba-if=\"{{enable_secondary_select && secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <input id=\"file-input-secondary-opt2\" ba-if=\"{{enable_secondary_select && !secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <span>      {{secondary_label}}     </span>    </div>   </div>  </div> </div> ","video_recorder_controlbar":"<div class=\"{{css}}-dashboard\">  <div class=\"{{css}}-backbar\"></div>  <div id=\"recorder-settings\" class=\"{{css}}-settings\" ba-show=\"{{settingsvisible && settingsopen}}\">   <div class=\"{{css}}-settings-backbar\"></div>   <div id=\"settings-list-front\" class=\"{{css}}-settings-front\">    <ul id=\"camera-settings\" ba-repeat=\"{{camera :: cameras}}\">     <li>      <input type='radio' name='camera' value=\"{{selectedcamera == camera.id}}\" onclick=\"{{selectCamera(camera.id)}}\" />      <span></span>      <label onclick=\"{{selectCamera(camera.id)}}\">       {{camera.label}}      </label>      </li>    </ul>    <hr ba-show=\"{{!noaudio}}\"/>    <ul id=\"microphone-settings\" ba-repeat=\"{{microphone :: microphones}}\" ba-show=\"{{!noaudio}}\">     <li onclick=\"{{selectMicrophone(microphone.id)}}\">      <input type='radio' name='microphone' value=\"{{selectedmicrophone == microphone.id}}\" />      <span></span>      <label>       {{microphone.label}}      </label>      </li>    </ul>   </div>  </div>  <div id=\"controlbar\" class=\"{{css}}-controlbar\">         <div class=\"{{css}}-leftbutton-container\" ba-show=\"{{settingsvisible}}\">             <div id=\"record-button-icon-cog\" class=\"{{css}}-button-inner {{css}}-button-{{settingsopen ? 'selected' : 'unselected'}}\"                  onclick=\"{{settingsopen=!settingsopen}}\"                  onmouseenter=\"{{hover(string('settings'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <i class=\"{{css}}-icon-cog\"></i>             </div>         </div>         <div class=\"{{css}}-lefticon-container\" ba-show=\"{{settingsvisible}}\">             <div id=\"record-button-icon-videocam\" class=\"{{css}}-icon-inner\"                  onmouseenter=\"{{hover(string(camerahealthy ? 'camerahealthy' : 'cameraunhealthy'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <i class=\"{{css}}-icon-videocam {{css}}-icon-state-{{camerahealthy ? 'good' : 'bad' }}\"></i>             </div>         </div>         <div class=\"{{css}}-lefticon-container\" ba-show=\"{{settingsvisible && !noaudio}}\">             <div id=\"record-button-icon-mic\" class=\"{{css}}-icon-inner\"                  onmouseenter=\"{{hover(string(microphonehealthy ? 'microphonehealthy' : 'microphoneunhealthy'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <i class=\"{{css}}-icon-mic {{css}}-icon-state-{{microphonehealthy ? 'good' : 'bad' }}\"></i>             </div>         </div>         <div class=\"{{css}}-lefticon-container\" ba-show=\"{{stopvisible && recordingindication}}\">             <div id=\"recording-indicator\" class=\"{{css}}-recording-indication\">             </div>         </div>         <div class=\"{{css}}-label-container\" ba-show=\"{{controlbarlabel}}\">          <div id=\"record-label-block\" class=\"{{css}}-label-label\">           {{controlbarlabel}}          </div>         </div>         <div class=\"{{css}}-rightbutton-container\" ba-show=\"{{recordvisible}}\">          <div id=\"record-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{record()}}\"                  onmouseenter=\"{{hover(string('record-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">           {{string('record')}}          </div>         </div>         <div class=\"{{css}}-rightbutton-container\" ba-if=\"{{uploadcovershotvisible}}\">          <div id=\"covershot-primary-button\" class=\"{{css}}-button-primary\"                  onmouseenter=\"{{hover(string('upload-covershot-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                  <input type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{uploadCovershot(domEvent)}}\"            accept=\"{{covershot_accept_string}}\" />                  <span>            {{string('upload-covershot')}}           </span>          </div>         </div>         <div class=\"{{css}}-rightbutton-container\" ba-show=\"{{rerecordvisible}}\">          <div id=\"rerecord-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{rerecord()}}\"                  onmouseenter=\"{{hover(string('rerecord-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">           {{string('rerecord')}}          </div>         </div>         <div class=\"{{css}}-rightbutton-container\" ba-show=\"{{stopvisible}}\">          <div id=\"stop-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{stop()}}\"                  onmouseenter=\"{{hover(string('stop-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">           {{string('stop')}}          </div>         </div>         <div class=\"{{css}}-centerbutton-container\" ba-show=\"{{skipvisible}}\">          <div id=\"skip-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{skip()}}\"                  onmouseenter=\"{{hover(string('skip-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">           {{string('skip')}}          </div>         </div>  </div> </div> ","video_recorder_imagegallery":"<div id=\"slider-left-button\" class=\"{{css}}-imagegallery-leftbutton\">  <div id=\"slider-left-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{left()}}\">   <i class=\"ba-videorecorder-icon-left-open\"></i>  </div> </div>  <div id=\"images-imagegallery-container\" ba-repeat=\"{{image::images}}\" class=\"{{css}}-imagegallery-container\" data-gallery-container>      <div class=\"{{css}}-imagegallery-image\"           ba-styles=\"{{{left: image.left + 'px', top: image.top + 'px', width: image.width + 'px', height: image.height + 'px'}}}\"           onclick=\"{{select(image)}}\">      </div> </div>  <div id=\"slider-right-button\" class=\"{{css}}-imagegallery-rightbutton\">  <div id=\"slider-right-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{right()}}\">   <i class=\"ba-videorecorder-icon-right-open\"></i>  </div> </div> ","video_recorder_loader":" <div class=\"{{css}}-loader-container\">     <div id=\"recorder-loader-block\" class=\"{{css}}-loader-loader\" title=\"{{tooltip}}\">     </div> </div> <div id=\"recorder-loader-label-container\" class=\"{{css}}-loader-label\" ba-show=\"{{label}}\">  {{label}} </div> ","video_recorder_message":" <div id=\"recorder-message-container\" class=\"{{css}}-message-container\" ba-click=\"click()\">     <div id=\"recorder-message-block\" class='{{css}}-message-message'>         {{message || \"\"}}     </div> </div> ","recorder":" <div id=\"recorder-container\" ba-show=\"{{!player_active}}\"      class=\"{{css}}-container {{css}}-size-{{csssize}} {{iecss}}-{{ie8 ? 'ie8' : 'noie8'}} {{csstheme}}\"      style=\"{{width ? 'width:' + width + ((width + '').match(/^\\d+$/g) ? 'px' : '') + ';' : 'width:100%;'}}{{height ? 'height:' + height + ((height + '').match(/^\\d+$/g) ? 'px' : '') + ';' : 'height:100%'}}\" >      <video id=\"recorder-status\" class=\"{{css}}-video {{css}}-{{hasrecorder ? 'hasrecorder' : 'norecorder'}}\" data-video=\"video\"></video>     <div id=\"recorder-overlay\" class='{{css}}-overlay' ba-show=\"{{!hideoverlay}}\" data-overlay=\"overlay\">   <ba-{{dynloader}}       ba-css=\"{{cssloader || css}}\"       ba-template=\"{{tmplloader}}\"       ba-show=\"{{loader_active}}\"       ba-tooltip=\"{{loadertooltip}}\"       ba-label=\"{{loaderlabel}}\"   ></ba-{{dynloader}}>    <ba-{{dynmessage}}       ba-css=\"{{cssmessage || css}}\"       ba-template=\"{{tmplmessage}}\"       ba-show=\"{{message_active}}\"       ba-message=\"{{message}}\"       ba-event:click=\"message_click\"   ></ba-{{dynmessage}}>    <ba-{{dyntopmessage}}       ba-css=\"{{csstopmessage || css}}\"       ba-template=\"{{tmpltopmessage}}\"       ba-show=\"{{topmessage_active && (topmessage || hovermessage)}}\"       ba-topmessage=\"{{hovermessage || topmessage}}\"   ></ba-{{dyntopmessage}}>    <ba-{{dynchooser}}       ba-css=\"{{csschooser || css}}\"       ba-template=\"{{tmplchooser}}\"       ba-show=\"{{chooser_active}}\"       ba-allowrecord=\"{{allowrecord}}\"       ba-allowupload=\"{{allowupload}}\"       ba-allowcustomupload=\"{{allowcustomupload}}\"       ba-primaryrecord=\"{{primaryrecord}}\"       ba-event:record=\"record_video\"       ba-event:upload=\"upload_video\"   ></ba-{{dynchooser}}>    <ba-{{dynimagegallery}}       ba-css=\"{{cssimagegallery || css}}\"       ba-template=\"{{tmplimagegallery}}\"       ba-if=\"{{imagegallery_active}}\"       ba-imagecount=\"{{gallerysnapshots}}\"       ba-imagenativewidth=\"{{recordingwidth}}\"       ba-imagenativeheight=\"{{recordingheight}}\"       ba-event:image-selected=\"select_image\"   ></ba-{{dynimagegallery}}>    <ba-{{dyncontrolbar}}       ba-css=\"{{csscontrolbar || css}}\"       ba-template=\"{{tmplcontrolbar}}\"       ba-show=\"{{controlbar_active}}\"       ba-cameras=\"{{cameras}}\"       ba-microphones=\"{{microphones}}\"       ba-noaudio=\"{{noaudio}}\"       ba-selectedcamera=\"{{selectedcamera || 0}}\"       ba-selectedmicrophone=\"{{selectedmicrophone || 0}}\"       ba-camerahealthy=\"{{camerahealthy}}\"       ba-microphonehealthy=\"{{microphonehealthy}}\"       ba-hovermessage=\"{{=hovermessage}}\"       ba-settingsvisible=\"{{settingsvisible}}\"       ba-recordvisible=\"{{recordvisible}}\"       ba-uploadcovershotvisible=\"{{uploadcovershotvisible}}\"       ba-rerecordvisible=\"{{rerecordvisible}}\"       ba-stopvisible=\"{{stopvisible}}\"       ba-skipvisible=\"{{skipvisible}}\"       ba-controlbarlabel=\"{{controlbarlabel}}\"       ba-event:select-camera=\"select_camera\"       ba-event:select-microphone=\"select_microphone\"       ba-event:invoke-record=\"record\"       ba-event:invoke-rerecord=\"rerecord\"       ba-event:invoke-stop=\"stop\"       ba-event:invoke-skip=\"invoke_skip\"       ba-event:upload-covershot=\"upload_covershot\"   ></ba-{{dyncontrolbar}}>     </div> </div>  <div id=\"recorder-player\" ba-if=\"{{player_active}}\"      style=\"{{width ? 'width:' + width + ((width + '').match(/^\\d+$/g) ? 'px' : '') + ';' : ''}}{{height ? 'height:' + height + ((height + '').match(/^\\d+$/g) ? 'px' : '') + ';' : ''}}\" >  <ba-{{dynvideoplayer}} ba-theme=\"{{theme || 'default'}}\"                         ba-source=\"{{playbacksource}}\"                         ba-poster=\"{{playbackposter}}\"                         ba-hideoninactivity=\"{{false}}\"                         ba-forceflash=\"{{forceflash}}\"                         ba-noflash=\"{{noflash}}\"                         ba-stretch=\"{{stretch}}\"                         ba-attrs=\"{{playerattrs}}\"                         ba-data:id=\"player\"                         ba-width=\"{{width}}\"                         ba-height=\"{{height}}\"                         ba-rerecordable=\"{{rerecordable && (recordings === null || recordings > 0)}}\"                         ba-submittable=\"{{manualsubmit}}\"                         ba-reloadonplay=\"{{true}}\"                         ba-autoplay=\"{{autoplay}}\"                         ba-nofullscreen=\"{{nofullscreen}}\"                         ba-topmessage=\"{{playertopmessage}}\"                         ba-event:rerecord=\"rerecord\"                         ba-event:playing=\"playing\"                         ba-event:paused=\"paused\"                         ba-event:ended=\"ended\"                         ba-event:submit=\"manual_submit\"                         >  </ba-{{dynvideoplayer}}> </div> ","video_recorder_topmessage":" <div class=\"{{css}}-topmessage-container\">     <div class='{{css}}-topmessage-background'>     </div>     <div id=\"recorder-topmessage-block\" class='{{css}}-topmessage-message'>         {{topmessage}}     </div> </div> ","cube-video_player_controlbar":"<div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideoninactivity ? (css + '-dashboard-hidden') : ''}}\">      <div class=\"{{css}}-left-block\">          <div id=\"submit-video-button\" class=\"{{css}}-button-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">             <div class=\"{{css}}-button-inner\">                 {{string('submit-video')}}             </div>         </div>          <div id=\"button-icon-ccw\" class=\"{{css}}-button-container\" ba-if=\"{{rerecordable}}\" ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-ccw\"></i>             </div>         </div>          <div id=\"button-icon-play\" class=\"{{css}}-button-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-play\"></i>             </div>         </div>          <div id=\"button-icon-pause\" class=\"{{css}}-button-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-pause\"></i>             </div>         </div>     </div>      <div class=\"{{css}}-right-block\">          <div class=\"{{css}}-button-container {{css}}-timer-container\">             <div class=\"{{css}}-time-container\">                 <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{duration_formatted}}</div>             </div>             <p> / </p>             <div class=\"{{css}}-time-container\">                 <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}</div>             </div>         </div>          <div id=\"button-icon-volume\" class=\"{{css}}-button-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>             </div>         </div>           <div id=\"button-stream-label\" class=\"{{css}}-button-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">             <div class=\"{{css}}-button-inner {{css}}-stream-label-container\">                 <span class=\"{{css}}-button-text {{css}}-stream-label\">{{currentstream_label}}</span>             </div>         </div>          <div id=\"button-icon-resize-full\" class=\"{{css}}-button-container\"  ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">             <div class=\"{{css}}-button-inner {{css}}-full-screen-btn-inner\">                 <i class=\"{{css}}-icon-resize-full\"></i>             </div>         </div>        </div>      <div class=\"{{css}}-progressbar\">         <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar-inner\"              onmousedown=\"{{startUpdatePosition(domEvent)}}\"              onmouseup=\"{{stopUpdatePosition(domEvent)}}\"              onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"              onmousemove=\"{{progressUpdatePosition(domEvent)}}\">              <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>             <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\"></div>         </div>     </div>  </div> ","elevate-video_player_controlbar":" <div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideoninactivity ? (css + '-dashboard-hidden') : ''}}\">      <div class=\"{{css}}-top-block\">          <div class=\"{{css}}-top-right-block\">              <div class=\"{{css}}-time-container {{css}}-right-time-container\">                 <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{duration_formatted}}</div>             </div>          </div>          <div class=\"{{css}}-progressbar\">             <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar-inner\"                  onmousedown=\"{{startUpdatePosition(domEvent)}}\"                  onmouseup=\"{{stopUpdatePosition(domEvent)}}\"                  onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"                  onmousemove=\"{{progressUpdatePosition(domEvent)}}\">                  <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>                 <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\">                     <div class=\"{{css}}-progressbar-button-description\" style=\"display: none\">                         <div class=\"{{css}}-current-stream-screen-shot\">                             <img src=\"\"/>                         </div>                         <div class=\"{{css}}-time-container\">                             <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}</div>                         </div>                     </div>                     <div class=\"{{css}}-progressbar-button\"></div>                 </div>             </div>         </div>      </div>      <div class=\"{{css}}-bottom-block\">          <div class=\"{{css}}-left-block\">              <div id=\"submit-video-button\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">                 <div class=\"{{css}}-button-inner\">                     {{string('submit-video')}}                 </div>             </div>              <div id=\"button-icon-ccw\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{rerecordable}}\" ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css}}-icon-ccw\"></i>                 </div>             </div>              <div id=\"button-icon-play\" class=\"{{css}}-button-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css}}-icon-play\"></i>                 </div>             </div>              <div id=\"button-icon-pause\" class=\"{{css}}-button-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css}}-icon-pause\"></i>                 </div>             </div>              <div id=\"button-icon-volume\" class=\"{{css}}-button-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>                 </div>             </div>          </div>          <div class=\"{{css}}-center-block\">             <div class=\"{{css}}-video-title-block\">              </div>         </div>          <div class=\"{{css}}-right-block\">              <div id=\"button-stream-label\" class=\"{{css}}-button-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">                 <div class=\"{{css}}-button-inner {{css}}-stream-label-container\">                     <span class=\"{{css}}-button-text {{css}}-stream-label\">{{currentstream_label}}</span>                 </div>             </div>              <div id=\"button-icon-resize-full\" class=\"{{css}}-button-container\"  ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">                 <div class=\"{{css}}-button-inner {{css}}-full-screen-btn-inner\">                     <i class=\"{{css}}-icon-resize-full\"></i>                 </div>             </div>          </div>      </div> </div> ","minimalist-video_player_controlbar":"<div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideoninactivity ? (css + '-dashboard-hidden') : ''}}\">      <div class='{{css}}-controlbar-header'>         <div class=\"{{css}}-controlbar-header-icons-block\">              <div class=\"{{css}}-right-block\">                  <div id=\"button-icon-resize-full\" class=\"{{css}}-button-container\"  ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">                     <div class=\"{{css}}-button-inner {{css}}-full-screen-btn-inner\">                         <i class=\"{{css}}-icon-resize-full\"></i>                     </div>                 </div>                  <div id=\"button-icon-volume\" class=\"{{css}}-button-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">                     <div class=\"{{css}}-button-inner\">                         <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>                     </div>                 </div>              </div>          </div>          <div class=\"{{css}}-controlbar-header-title-block\">             <div class=\"{{css}}-title\"><h4>Video Title</h4></div>         </div>     </div>      <div class=\"{{css}}-controlbar-footer\">          <div class=\"{{css}}-controlbar-top-block\">              <div id=\"submit-video-button\" class=\"{{css}}-button-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">                 <div class=\"{{css}}-button-inner\">                     {{string('submit-video')}}                 </div>             </div>              <div id=\"button-icon-ccw\" class=\"{{css}}-button-container\" ba-if=\"{{rerecordable}}\" ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css}}-icon-ccw\"></i>                 </div>             </div>              <div id=\"button-icon-play\" class=\"{{css}}-button-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css}}-icon-play\"></i>                 </div>             </div>              <div id=\"button-icon-pause\" class=\"{{css}}-button-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">                 <div class=\"{{css}}-button-inner\">                     <i class=\"{{css}}-icon-pause\"></i>                 </div>             </div>          </div>         <div class=\"{{css}}-controlbar-middle-block\">              <div class=\"{{css}}-progressbar\">                 <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar-inner\"                      onmousedown=\"{{startUpdatePosition(domEvent)}}\"                      onmouseup=\"{{stopUpdatePosition(domEvent)}}\"                      onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"                      onmousemove=\"{{progressUpdatePosition(domEvent)}}\">                      <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>                     <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\">                         <div class=\"{{css}}-progressbar-button\"></div>                     </div>                 </div>             </div>          </div>         <div class=\"{{css}}-controlbar-bottom-block\">              <div class=\"{{css}}-button-container {{css}}-time-container\">                 <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}</div>                 <p> / </p>                 <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{duration_formatted}}</div>             </div>              <div id=\"button-stream-label\" class=\"{{css}}-button-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">                 <div class=\"{{css}}-button-inner {{css}}-stream-label-container\">                     <span class=\"{{css}}-button-text {{css}}-stream-label\">{{currentstream_label}}</span>                 </div>             </div>         </div>     </div>  </div> ","modern-video_player_controlbar":" <div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideoninactivity ? (css + '-dashboard-hidden') : ''}}\">         <div id=\"submit-video-button\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">             <div class=\"{{css}}-button-inner\">                 {{string('submit-video')}}             </div>         </div>        <div id=\"button-icon-ccw\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{rerecordable}}\" ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">            <div class=\"{{css}}-button-inner\">                <i class=\"{{css}}-icon-ccw\"></i>            </div>        </div>  <div id=\"button-icon-play\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">   <div class=\"{{css}}-button-inner\">    <i class=\"{{css}}-icon-play\"></i>   </div>  </div>  <div id=\"button-icon-pause\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">   <div class=\"{{css}}-button-inner\">    <i class=\"{{css}}-icon-pause\"></i>   </div>  </div>  <div class=\"{{css}}-time-container\">   <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}/{{duration_formatted}}</div>  </div>  <div id=\"button-icon-resize-full\" class=\"{{css}}-rightbutton-container\" ba-if=\"{{fullscreen}}\" ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">   <div class=\"{{css}}-button-inner\">    <i class=\"{{css}}-icon-resize-full\"></i>   </div>  </div>  <div id=\"button-stream-label\" class=\"{{css}}-rightbutton-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">   <div class=\"{{css}}-button-inner\">    <span class=\"{{css}}-button-text\">{{currentstream_label}}</span>   </div>  </div>  <div class=\"{{css}}-volumebar\">   <div id=\"button-volume-bar\" class=\"{{css}}-volumebar-inner\"           onmousedown=\"{{startUpdateVolume(domEvent)}}\"                 onmouseup=\"{{stopUpdateVolume(domEvent)}}\"                 onmouseleave=\"{{stopUpdateVolume(domEvent)}}\"                 onmousemove=\"{{progressUpdateVolume(domEvent)}}\">    <div class=\"{{css}}-volumebar-position\" ba-styles=\"{{{width: Math.ceil(1+Math.min(99, Math.round(volume * 100))) + '%'}}}\" title=\"{{string('volume-button')}}\"></div>   </div>  </div>  <div id=\"button-icon-volume\" class=\"{{css}}-rightbutton-container {{css}}-volume-button-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">   <div class=\"{{css}}-button-inner\">    <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>   </div>  </div>  <div class=\"{{css}}-progressbar\">   <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar-inner\"        onmousedown=\"{{startUpdatePosition(domEvent)}}\"        onmouseup=\"{{stopUpdatePosition(domEvent)}}\"        onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"        onmousemove=\"{{progressUpdatePosition(domEvent)}}\">   <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>   <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\"></div>  </div> </div> ","space-video_player_controlbar":"<div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideoninactivity ? (css + '-dashboard-hidden') : ''}}\">       <div class='{{css}}-controlbar-header'>         <div class=\"{{css}}-title\">Title of the video</div>          <div id=\"button-icon-volume\" class=\"{{css}}-rightbutton-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>             </div>         </div>          <div id=\"button-icon-cog\" class=\"{{css}}-rightbutton-container {{css}}-share-button-container\" ba-click=\"share_media()\" title=\"{{string('share-media')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-cog\"></i>             </div>         </div>     </div>       <div class=\"{{css}}-controlbar-footer\">         <div id=\"submit-video-button\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">            <div class=\"{{css}}-button-inner\">                {{string('submit-video')}}            </div>        </div>         <div id=\"button-icon-ccw\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{rerecordable}}\" ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">            <div class=\"{{css}}-button-inner\">                <i class=\"{{css}}-icon-ccw\"></i>            </div>        </div>         <div id=\"button-icon-play\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">            <div class=\"{{css}}-button-inner\">                <i class=\"{{css}}-icon-play\"></i>            </div>        </div>         <div id=\"button-icon-pause\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">            <div class=\"{{css}}-button-inner\">                <i class=\"{{css}}-icon-pause\"></i>            </div>        </div>         <div class=\"{{css}}-time-container\">            <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}</div>        </div>         <div id=\"button-icon-resize-full\" class=\"{{css}}-rightbutton-container\"  ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">            <div class=\"{{css}}-button-inner {{css}}-full-screen-btn-inner\">                <i class=\"{{css}}-icon-resize-full\"></i>            </div>        </div>         <div id=\"button-stream-label\" class=\"{{css}}-rightbutton-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">            <div class=\"{{css}}-button-inner {{css}}-stream-label-container\">                <span class=\"{{css}}-button-text {{css}}-stream-label\">{{currentstream_label}}</span>            </div>        </div>         <div class=\"{{css}}-time-container {{css}}-rightbutton-container {{css}}-right-time-container\">            <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{duration_formatted}}</div>        </div>         <div class=\"{{css}}-progressbar\">            <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar-inner\"                 onmousedown=\"{{startUpdatePosition(domEvent)}}\"                 onmouseup=\"{{stopUpdatePosition(domEvent)}}\"                 onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"                 onmousemove=\"{{progressUpdatePosition(domEvent)}}\">                 <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>                <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\">                    <div class=\"{{css}}-progressbar-button\"></div>                </div>            </div>        </div>      </div>  </div> ","space-video_player_message":"<div class=\"{{css}}-message-container\" ba-click=\"click()\">     <div id=\"message-block\" class=\"{{css}}-first-inner-message-container\">         <div class=\"{{css}}-second-inner-message-container\">             <div class=\"{{css}}-third-inner-message-container\">                 <div class=\"{{css}}-fourth-inner-message-container\">                     <div class='{{css}}-message-message'>                         {{message || \"\"}}                     </div>                 </div>             </div>         </div>     </div> </div> ","space-video_player_playbutton":" <div id=\"play-button\" class=\"{{css}}-playbutton-container\" ba-click=\"play()\" title=\"{{string('tooltip')}}\">  <div class=\"{{css}}-playbutton-button\"></div> </div>  <div class=\"{{css}}-rerecord-bar\" ba-if=\"{{rerecordable || submittable}}\">  <div class=\"{{css}}-rerecord-frontbar\">         <div class=\"{{css}}-rerecord-button-container\" ba-if=\"{{submittable}}\">             <div id=\"player-submit-button\" class=\"{{css}}-rerecord-button\" onclick=\"{{submit()}}\">                 {{string('submit-video')}}             </div>         </div>         <div class=\"{{css}}-rerecord-button-container\" ba-if=\"{{rerecordable}}\">          <div id=\"player-rerecord-button\" class=\"{{css}}-rerecord-button\" onclick=\"{{rerecord()}}\">           {{string('rerecord')}}          </div>         </div>  </div> </div> ","theatre-video_player_controlbar":" <div class=\"{{css}}-dashboard {{activitydelta > 5000 && hideoninactivity ? (css + '-dashboard-hidden') : ''}}\">      <div class=\"{{css}}-left-block\">          <div id=\"submit-video-button\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{submittable}}\"  ba-click=\"submit()\">             <div class=\"{{css}}-button-inner\">                 {{string('submit-video')}}             </div>         </div>          <div id=\"button-icon-ccw\" class=\"{{css}}-leftbutton-container\" ba-if=\"{{rerecordable}}\" ba-click=\"rerecord()\" title=\"{{string('rerecord-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-ccw\"></i>             </div>         </div>          <div id=\"button-icon-play\" class=\"{{css}}-button-container\" ba-if=\"{{!playing}}\" ba-click=\"play()\" title=\"{{string('play-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-play\"></i>             </div>         </div>          <div id=\"button-icon-pause\" class=\"{{css}}-button-container\" ba-if=\"{{playing}}\" ba-click=\"pause()\" title=\"{{string('pause-video')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css}}-icon-pause\"></i>             </div>         </div>          <div id=\"button-icon-volume\" class=\"{{css}}-button-container\" ba-click=\"toggle_volume()\" title=\"{{string(volume > 0 ? 'volume-mute' : 'volume-unmute')}}\">             <div class=\"{{css}}-button-inner\">                 <i class=\"{{css + '-icon-volume-' + (volume >= 0.5 ? 'up' : (volume > 0 ? 'down' : 'off')) }}\"></i>             </div>         </div>          <div class=\"{{css}}-time-container\">             <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{position_formatted}}</div>         </div>     </div>      <div class=\"{{css}}-right-block\">          <div id=\"button-icon-resize-full\" class=\"{{css}}-button-container {{css}}-fullscreen-icon-container\"  ba-click=\"toggle_fullscreen()\" title=\"{{string('fullscreen-video')}}\">             <div class=\"{{css}}-button-inner {{css}}-full-screen-btn-inner\">                 <i class=\"{{css}}-icon-resize-full\"></i>             </div>         </div>          <div id=\"button-stream-label\" class=\"{{css}}-button-container {{css}}-stream-label-container\" ba-if=\"{{streams.length > 1 && currentstream}}\" ba-click=\"toggle_stream()\" title=\"{{string('change-resolution')}}\">             <div class=\"{{css}}-button-inner {{css}}-stream-label-container\">                 <span class=\"{{css}}-button-text {{css}}-stream-label\">{{currentstream_label}}</span>             </div>         </div>          <div class=\"{{css}}-time-container {{css}}-right-time-container\">             <div class=\"{{css}}-time-value\" title=\"{{string('elapsed-time')}}\">{{duration_formatted}}</div>         </div>      </div>      <div class=\"{{css}}-progressbar\">         <div id=\"progress-bar-inner\" class=\"{{css}}-progressbar-inner\"              onmousedown=\"{{startUpdatePosition(domEvent)}}\"              onmouseup=\"{{stopUpdatePosition(domEvent)}}\"              onmouseleave=\"{{stopUpdatePosition(domEvent)}}\"              onmousemove=\"{{progressUpdatePosition(domEvent)}}\">              <div class=\"{{css}}-progressbar-cache\" ba-styles=\"{{{width: Math.round(duration ? cached / duration * 100 : 0) + '%'}}}\"></div>             <div class=\"{{css}}-progressbar-position\" ba-styles=\"{{{width: Math.round(duration ? position / duration * 100 : 0) + '%'}}}\" title=\"{{string('video-progress')}}\">                 <div class=\"{{css}}-progressbar-button\"></div>             </div>         </div>     </div>  </div> ","cube-video_recorder_chooser":" <div class=\"{{css}}-chooser-container\">   <div class=\"{{css}}-chooser-button-container\">    <div class=\"{{css}}-chooser-icon-container\">    <i class=\"{{css}}-icon-{{primaryrecord ? 'videocam' : 'upload'}}\"></i>   </div>   <div>    <div id=\"player-submit-button\" class=\"{{css}}-chooser-primary-button\"         ba-click=\"primary()\"         ba-if=\"{{has_primary}}\">     <input id=\"file-input-opt1\" ba-if=\"{{enable_primary_select && primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\"            capture />     <input id=\"file-input-opt2\" ba-if=\"{{enable_primary_select && !primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\" />     <span>      {{primary_label}}     </span>    </div>   </div>   <div>    <div id=\"chooser-secondary-button\" class=\"{{css}}-chooser-secondary-button\"         ba-click=\"secondary()\"         ba-if=\"{{has_secondary}}\">     <input id=\"file-input-secondary-opt1\" ba-if=\"{{enable_secondary_select && secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <input id=\"file-input-secondary-opt2\" ba-if=\"{{enable_secondary_select && !secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <span>      {{secondary_label}}     </span>    </div>   </div>  </div> </div> ","cube-video_recorder_controlbar":"<div class=\"{{css}}-dashboard\">   <div class=\"{{css}}-settings-front\">    <!-- Popup Settings Selections, initially hidden, appear when click button for settings -->   <div id=\"recorder-settings\" class=\"{{css}}-settings\" ba-show=\"{{settingsvisible && settingsopen}}\">    <div id=\"settings-list-front\" class=\"{{css}}-bubble-info\">     <ul id=\"camera-settings\" ba-repeat=\"{{camera :: cameras}}\">      <li>       <input type='radio' name='camera' value=\"{{selectedcamera == camera.id}}\" onclick=\"{{selectCamera(camera.id)}}\" />       <span></span>       <label onclick=\"{{selectCamera(camera.id)}}\">        {{camera.label}}       </label>      </li>     </ul>     <ul id=\"microphone-settings\" ba-repeat=\"{{microphone :: microphones}}\" ba-show=\"{{audio}}\">      <li onclick=\"{{selectMicrophone(microphone.id)}}\">       <input type='radio' name='microphone' value=\"{{selectedmicrophone == microphone.id}}\" />       <span></span>       <label>        {{microphone.label}}       </label>      </li>     </ul>    </div>   </div>   </div>   <!-- Control bar, footer part which holds all buttons -->  <div id=\"controlbar\" class=\"{{css}}-controlbar\">    <div class=\"{{css}}-controlbar-center-section\">     <div class=\"{{css}}-button-container\" ba-show=\"{{rerecordvisible}}\">     <div id=\"rerecord-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{rerecord()}}\"       onmouseenter=\"{{hover(string('rerecord-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('rerecord')}}     </div>    </div>    </div>    <div class=\"{{css}}-controlbar-left-section\" ba-show=\"{{settingsvisible}}\">              <div class=\"{{css}}-cube-button\" ba-show=\"{{settingsvisible}}\">      <div id=\"record-button-icon-cog\" class=\"{{css}}-button-inner {{css}}-button-cube-{{settingsopen ? 'selected' : 'unselected' }}\"       onclick=\"{{settingsopen=!settingsopen}}\"       onmouseenter=\"{{hover(string('settings'))}}\"       onmouseleave=\"{{unhover()}}\" >      <i class=\"{{css}}-icon-cog\"></i>     </div>     </div>     <div class=\"{{css}}-cube-button\" ba-show=\"{{!noaudio}}\">     <div id=\"record-button-icon-mic\" class=\"{{css}}-button-inner\"      onmouseenter=\"{{hover(string(microphonehealthy ? 'microphonehealthy' : 'microphoneunhealthy'))}}\"      onmouseleave=\"{{unhover()}}\">      <i class=\"{{css}}-icon-mic {{css}}-icon-state-{{minrophonehealthy ? 'good' : 'bad' }}\"></i>     </div>    </div>     <div class=\"{{css}}-cube-button\">     <div id=\"record-button-icon-videocam\" class=\"{{css}}-button-inner\"      onmouseenter=\"{{hover(string(camerahelthy ? 'camerahealthy' : 'cameraunhelathy'))}}\"      onmouseleave=\"{{unhover()}}\">                     <i class=\"{{css}}-icon-videocam {{css}}-icon-state-{{ camerahealthy ? 'good' : 'bad' }}\"></i>     </div>    </div>   </div>    <div class=\"{{css}}-controlbar-right-section\">     <div class=\"{{css}}-rightbutton-container\" ba-show=\"{{recordvisible}}\">     <div id=\"record-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{record()}}\"       onmouseenter=\"{{hover(string('record-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('record')}}     </div>    </div>    </div>    <div class=\"{{css}}-stop-container\" ba-show=\"{{stopvisible}}\">     <div class=\"{{css}}-timer-container\">     <div class=\"{{css}}-label-container\" ba-show=\"{{controlbarlabel}}\">      <div id=\"record-label-block\" class=\"{{css}}-label {{css}}-button-primary\">       {{controlbarlabel}}      </div>     </div>    </div>     <div class=\"{{css}}-stop-button-container\">     <div id=\"stop-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{stop()}}\"       onmouseenter=\"{{hover(string('stop-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('stop')}}     </div>    </div>   </div>          <div class=\"{{css}}-centerbutton-container\" ba-show=\"{{skipvisible}}\">             <div id=\"skip-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{skip()}}\"                  onmouseenter=\"{{hover(string('skip-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('skip')}}             </div>         </div>           <div class=\"{{css}}-rightbutton-container\" ba-if=\"{{uploadcovershotvisible}}\">             <div id=\"covershot-primary-button\" class=\"{{css}}-button-primary\"                  onmouseenter=\"{{hover(string('upload-covershot-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <input type=\"file\"                        class=\"{{css}}-chooser-file\"                        style=\"height:100px\"                        onchange=\"{{uploadCovershot(domEvent)}}\"                        accept=\"{{covershot_accept_string}}\" />                 <span>                     {{string('upload-covershot')}}                 </span>             </div>         </div>   </div>  </div> ","cube-video_recorder_imagegallery":"<div id=\"image-gallery\" class=\"{{css}}-image-gallery-container\">   <div id=\"slider-left-button\" class=\"{{css}}-imagegallery-leftbutton\">   <div id=\"slider-left-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{left()}}\">    <i class=\"ba-videorecorder-icon-left-open\"></i>   </div>  </div>   <div id=\"images-imagegallery-container\" ba-repeat=\"{{image::images}}\" class=\"{{css}}-imagegallery-container\" data-gallery-container>   <div class=\"{{css}}-imagegallery-image\"     ba-styles=\"{{{left: image.left + 'px', top: image.top + 'px', width: image.width + 'px', height: image.height + 'px'}}}\"     onclick=\"{{select(image)}}\">   </div>  </div>   <div id=\"slider-right-button\" class=\"{{css}}-imagegallery-rightbutton\">   <div id=\"slider-right-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{right()}}\">    <i class=\"ba-videorecorder-icon-right-open\"></i>   </div>  </div>  </div> ","cube-video_recorder_loader":" <div class=\"{{css}}-loader-container\" ba-show=\"{{!label}}\">     <div id=\"recorder-loader-block\" class=\"{{css}}-loader-loader\" title=\"{{tooltip}}\">     </div> </div> <div id=\"recorder-loader-label-container\" class=\"{{css}}-loader-label\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-label-container\">         <div class=\"{{css}}-loader-countdown\">             <div id=\"recorder-loader-label\" class=\"{{css}}-button-primary\">                 {{string('starts-in')}} {{label}}             </div>         </div>         <div class=\"{{css}}-wait-button-container\">             <div id=\"recorder-loader-wait-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{freeze()}}\"                  onmouseenter=\"{{hover(string('wait-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('wait')}}             </div>         </div>     </div> </div> ","cube-video_recorder_message":"<div id=\"recorder-message-container\" class=\"{{css}}-message-container\" ba-click=\"click()\">     <div class=\"{{css}}-top-inner-message-container\">         <div class=\"{{css}}-first-inner-message-container\">             <div class=\"{{css}}-second-inner-message-container\">                 <div class=\"{{css}}-third-inner-message-container\">                     <div class=\"{{css}}-fourth-inner-message-container\">                         <div id=\"recorder-message-block\" class='{{css}}-message-message'>                             {{message || \"\"}}                         </div>                     </div>                 </div>             </div>         </div>     </div> </div> ","elevate-video_recorder_controlbar":"<div class=\"{{css}}-dashboard\">   <!-- Sidebar Settings -->  <div class=\"{{css}}-settings-left-sidebar\">    <div class=\"{{css}}-controlbar-left-section\" ba-show=\"{{settingsvisible}}\">     <!-- Popup Settings Selections, initially hidden, appear when click button for settings -->    <div id=\"recorder-settings\" class=\"{{css}}-settings {{css}}-settings-button-container\">      <div class=\"{{css}}-circle-button\" ba-show=\"{{settingsvisible}}\">       <div class=\"{{css}}-bubble-info\" ba-show=\"{{settingsopen}}\" >       <ul id=\"camera-settings\" ba-repeat=\"{{camera :: cameras}}\">        <li>         <input type='radio' name='camera' value=\"{{selectedcamera == camera.id}}\" onclick=\"{{selectCamera(camera.id)}}\" />         <span></span>         <label onclick=\"{{selectCamera(camera.id)}}\">          {{camera.label}}         </label>        </li>       </ul>      </div>       <div id=\"record-button-icon-cog\" class=\"{{css}}-button-inner {{css}}-button-circle-{{settingsopen ? 'selected' : 'unselected' }}\"        onclick=\"{{settingsopen=!settingsopen}}\"        onmouseenter=\"{{hover(string('settings'))}}\"        onmouseleave=\"{{unhover()}}\" >       <i class=\"{{css}}-icon-cog\"></i>      </div>      </div>                   <div class=\"{{css}}-circle-button\" ba-show=\"{{!noaudio}}\">                      <div class=\"{{css}}-bubble-info\" ba-show=\"{{settingsvisible && settingsopen && audio }}\">                         <ul id=\"microphone-settings\" ba-repeat=\"{{microphone :: microphones}}\" ba-show=\"{{audio}}\">                             <li onclick=\"{{selectMicrophone(microphone.id)}}\">                                 <input type='radio' name='microphone' value=\"{{selectedmicrophone == microphone.id}}\" />                                 <span></span>                                 <label>                                     {{microphone.label}}                                 </label>                             </li>                         </ul>                     </div>                      <div id=\"record-button-icon-mic\" class=\"{{css}}-button-inner\"                          onmouseenter=\"{{hover(string(microphonehealthy ? 'microphonehealthy' : 'microphoneunhealthy'))}}\"                          onmouseleave=\"{{unhover()}}\">                         <i class=\"{{css}}-icon-mic {{css}}-icon-state-{{minrophonehealthy ? 'good' : 'bad' }}\"></i>                     </div>                 </div>                  <div class=\"{{css}}-circle-button\">                     <div id=\"record-button-icon-videocam\" class=\"{{css}}-button-inner\"                          onmouseenter=\"{{hover(string(camerahelthy ? 'camerahealthy' : 'cameraunhelathy'))}}\"                          onmouseleave=\"{{unhover()}}\">                         <i class=\"{{css}}-icon-videocam {{css}}-icon-state-{{ camerahealthy ? 'good' : 'bad' }}\"></i>                     </div>                 </div>     </div>   </div>   </div>   <div class=\"{{css}}-controlbar-middle-section\">    <div class=\"{{css}}-timer-container\" ba-show=\"{{stopvisible}}\">    <div class=\"{{css}}-label-container\" ba-show=\"{{controlbarlabel}}\">     <div id=\"record-label-block\" class=\"{{css}}-label {{css}}-button-primary\">      {{controlbarlabel}}     </div>    </div>   </div>   </div>   <!-- Control bar, footer part which holds all buttons -->  <div id=\"controlbar\" class=\"{{css}}-controlbar\">    <div class=\"{{css}}-controlbar-center-section\">     <div class=\"{{css}}-button-container\" ba-show=\"{{rerecordvisible}}\">     <div id=\"rerecord-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{rerecord()}}\"       onmouseenter=\"{{hover(string('rerecord-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('rerecord')}}     </div>    </div>     <div class=\"{{css}}-primary-button-container\" ba-show=\"{{recordvisible}}\">     <div id=\"record-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{record()}}\"       onmouseenter=\"{{hover(string('record-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('record')}}     </div>    </div>    </div>    <div class=\"{{css}}-stop-container\" ba-show=\"{{stopvisible}}\">     <div class=\"{{css}}-stop-button-container\">     <div id=\"stop-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{stop()}}\"       onmouseenter=\"{{hover(string('stop-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('stop')}}     </div>    </div>   </div>          <div class=\"{{css}}-centerbutton-container\" ba-show=\"{{skipvisible}}\">             <div id=\"skip-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{skip()}}\"                  onmouseenter=\"{{hover(string('skip-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('skip')}}             </div>         </div>           <div class=\"{{css}}-rightbutton-container\" ba-if=\"{{uploadcovershotvisible}}\">             <div id=\"covershot-primary-button\" class=\"{{css}}-button-primary\"                  onmouseenter=\"{{hover(string('upload-covershot-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <input type=\"file\"                        class=\"{{css}}-chooser-file\"                        style=\"height:100px\"                        onchange=\"{{uploadCovershot(domEvent)}}\"                        accept=\"{{covershot_accept_string}}\" />                 <span>                     {{string('upload-covershot')}}                 </span>             </div>         </div>   </div>  </div> ","elevate-video_recorder_imagegallery":"<div id=\"image-gallery\" class=\"{{css}}-image-gallery-container\">   <div id=\"slider-left-button\" class=\"{{css}}-imagegallery-leftbutton\">   <div id=\"slider-left-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{left()}}\">    <i class=\"ba-videorecorder-icon-left-open\"></i>   </div>  </div>   <div id=\"images-imagegallery-container\" ba-repeat=\"{{image::images}}\" class=\"{{css}}-imagegallery-container\" data-gallery-container>   <div class=\"{{css}}-imagegallery-image\"     ba-styles=\"{{{left: image.left + 'px', top: image.top + 'px', width: image.width + 'px', height: image.height + 'px'}}}\"     onclick=\"{{select(image)}}\">   </div>  </div>   <div id=\"slider-right-button\" class=\"{{css}}-imagegallery-rightbutton\">   <div id=\"slider-right-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{right()}}\">    <i class=\"ba-videorecorder-icon-right-open\"></i>   </div>  </div>  </div> ","elevate-video_recorder_loader":"<div class=\"{{css}}-loader-container\" ba-show=\"{{!label}}\">     <div id=\"recorder-loader-block\" class=\"{{css}}-loader-loader\" title=\"{{tooltip}}\">     </div> </div> <div id=\"recorder-loader-label-container\" class=\"{{css}}-loader-container\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-countdown\">         <div id=\"recorder-loader-label\" class=\"{{css}}-button-primary\">             {{string('starts-in')}} {{label}}         </div>     </div> </div> <div class=\"{{css}}-loader-label\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-label-container\">         <div class=\"{{css}}-wait-button-container\">             <div id=\"recorder-loader-wait-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{freeze()}}\"                  onmouseenter=\"{{hover(string('wait-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('wait')}}             </div>         </div>     </div> </div> ","elevate-video_recorder_message":"<div id=\"recorder-message-container\" class=\"{{css}}-message-container\" ba-click=\"click()\">     <div class=\"{{css}}-top-inner-message-container\">         <div class=\"{{css}}-first-inner-message-container\">             <div class=\"{{css}}-second-inner-message-container\">                 <div class=\"{{css}}-third-inner-message-container\">                     <div class=\"{{css}}-fourth-inner-message-container\">                         <div id=\"recorder-message-block\" class='{{css}}-message-message'>                             {{message || \"\"}}                         </div>                     </div>                 </div>             </div>         </div>     </div> </div> ","elevate-video_recorder_topmessage":"<div class=\"{{css}}-topmessage-container\">     <div id=\"recorder-topmessage-block\" class='{{css}}-topmessage-message'>         {{topmessage}}     </div> </div> ","minimalist-video_recorder_controlbar":"<div class=\"{{css}}-dashboard\">   <!-- Sidebar Settings -->  <div class=\"{{css}}-settings-left-sidebar\">    <div class=\"{{css}}-controlbar-left-section\" ba-show=\"{{settingsvisible}}\">     <!-- Popup Settings Selections, initially hidden, appear when click button for settings -->    <div id=\"recorder-settings\" class=\"{{css}}-settings {{css}}-settings-button-container\">      <div id=\"settings-list-front\" class=\"{{css}}-circle-button\" ba-show=\"{{settingsvisible}}\">       <div class=\"{{css}}-bubble-info\" ba-show=\"{{settingsopen}}\" >       <ul id=\"camera-settings\" ba-repeat=\"{{camera :: cameras}}\">        <li>         <input type='radio' name='camera' value=\"{{selectedcamera == camera.id}}\" onclick=\"{{selectCamera(camera.id)}}\" />         <span></span>         <label onclick=\"{{selectCamera(camera.id)}}\">          {{camera.label}}         </label>        </li>       </ul>      </div>       <div id=\"record-button-icon-cog\" class=\"{{css}}-button-inner {{css}}-button-circle-{{settingsopen ? 'selected' : 'unselected' }}\"        onclick=\"{{settingsopen=!settingsopen}}\"        onmouseenter=\"{{hover(string('settings'))}}\"        onmouseleave=\"{{unhover()}}\" >       <i class=\"{{css}}-icon-cog\"></i>      </div>     </div>                   <div class=\"{{css}}-circle-button\" ba-show=\"{{!noaudio}}\">                      <div class=\"{{css}}-bubble-info\" ba-show=\"{{settingsvisible && settingsopen && audio }}\">                         <ul id=\"microphone-settings\" ba-repeat=\"{{microphone :: microphones}}\" ba-show=\"{{audio}}\">                             <li onclick=\"{{selectMicrophone(microphone.id)}}\">                                 <input type='radio' name='microphone' value=\"{{selectedmicrophone == microphone.id}}\" />                                 <span></span>                                 <label>                                     {{microphone.label}}                                 </label>                             </li>                         </ul>                     </div>                      <div id=\"record-button-icon-mic\" class=\"{{css}}-button-inner\"                          onmouseenter=\"{{hover(string(microphonehealthy ? 'microphonehealthy' : 'microphoneunhealthy'))}}\"                          onmouseleave=\"{{unhover()}}\">                         <i class=\"{{css}}-icon-mic {{css}}-icon-state-{{minrophonehealthy ? 'good' : 'bad' }}\"></i>                     </div>                 </div>                  <div class=\"{{css}}-circle-button\">                     <div id=\"record-button-icon-videocam\" class=\"{{css}}-button-inner\"                          onmouseenter=\"{{hover(string(camerahelthy ? 'camerahealthy' : 'cameraunhelathy'))}}\"                          onmouseleave=\"{{unhover()}}\">                         <i class=\"{{css}}-icon-videocam {{css}}-icon-state-{{ camerahealthy ? 'good' : 'bad' }}\"></i>                     </div>                 </div>     </div>   </div>   </div>   <div class=\"{{css}}-controlbar-middle-section\">    <div class=\"{{css}}-timer-container\" ba-show=\"{{stopvisible}}\">    <div class=\"{{css}}-label-container\" ba-show=\"{{controlbarlabel}}\">     <div id=\"record-label-block\" class=\"{{css}}-label {{css}}-button-primary\">      {{controlbarlabel}}     </div>    </div>   </div>   </div>   <!-- Control bar, footer part which holds all buttons -->  <div id=\"controlbar\" class=\"{{css}}-controlbar\">    <div class=\"{{css}}-controlbar-center-section\">     <div class=\"{{css}}-button-container\" ba-show=\"{{rerecordvisible}}\">     <div id=\"rerecord-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{rerecord()}}\"       onmouseenter=\"{{hover(string('rerecord-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('rerecord')}}     </div>    </div>     <div class=\"{{css}}-primary-button-container\" ba-show=\"{{recordvisible}}\">     <div id=\"record-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{record()}}\"       onmouseenter=\"{{hover(string('record-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('record')}}     </div>    </div>    </div>    <div class=\"{{css}}-stop-container\" ba-show=\"{{stopvisible}}\">     <div class=\"{{css}}-stop-button-container\">     <div id=\"stop-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{stop()}}\"       onmouseenter=\"{{hover(string('stop-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('stop')}}     </div>    </div>   </div>          <div class=\"{{css}}-centerbutton-container\" ba-show=\"{{skipvisible}}\">             <div id=\"skip-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{skip()}}\"                  onmouseenter=\"{{hover(string('skip-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('skip')}}             </div>         </div>           <div class=\"{{css}}-rightbutton-container\" ba-if=\"{{uploadcovershotvisible}}\">             <div id=\"covershot-primary-button\" class=\"{{css}}-button-primary\"                  onmouseenter=\"{{hover(string('upload-covershot-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <input type=\"file\"                        class=\"{{css}}-chooser-file\"                        style=\"height:100px\"                        onchange=\"{{uploadCovershot(domEvent)}}\"                        accept=\"{{covershot_accept_string}}\" />                 <span>                     {{string('upload-covershot')}}                 </span>             </div>         </div>   </div>  </div> ","minimalist-video_recorder_imagegallery":"<div id=\"image-gallery\" class=\"{{css}}-image-gallery-container\">   <div id=\"slider-left-button\" class=\"{{css}}-imagegallery-leftbutton\">   <div id=\"slider-left-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{left()}}\">    <i class=\"ba-videorecorder-icon-left-open\"></i>   </div>  </div>   <div id=\"images-imagegallery-container\" ba-repeat=\"{{image::images}}\" class=\"{{css}}-imagegallery-container\" data-gallery-container>   <div class=\"{{css}}-imagegallery-image\"     ba-styles=\"{{{left: image.left + 'px', top: image.top + 'px', width: image.width + 'px', height: image.height + 'px'}}}\"     onclick=\"{{select(image)}}\">   </div>  </div>   <div id=\"slider-right-button\" class=\"{{css}}-imagegallery-rightbutton\">   <div id=\"slider-right-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{right()}}\">    <i class=\"ba-videorecorder-icon-right-open\"></i>   </div>  </div>  </div> ","minimalist-video_recorder_loader":"<div class=\"{{css}}-loader-container\" ba-show=\"{{!label}}\">     <div id=\"recorder-loader-block\" class=\"{{css}}-loader-loader\" title=\"{{tooltip}}\">     </div> </div> <div id=\"recorder-loader-label-container\" class=\"{{css}}-loader-container\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-countdown\">         <div id=\"recorder-loader-label\" class=\"{{css}}-button-primary\">             {{string('starts-in')}} {{label}}         </div>     </div> </div> <div class=\"{{css}}-loader-label\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-label-container\">         <div class=\"{{css}}-wait-button-container\">             <div id=\"recorder-loader-wait-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{freeze()}}\"                  onmouseenter=\"{{hover(string('wait-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('wait')}}             </div>         </div>     </div> </div>","minimalist-video_recorder_message":"<div id=\"recorder-message-container\" class=\"{{css}}-message-container\" ba-click=\"click()\">     <div class=\"{{css}}-top-inner-message-container\">         <div class=\"{{css}}-first-inner-message-container\">             <div class=\"{{css}}-second-inner-message-container\">                 <div class=\"{{css}}-third-inner-message-container\">                     <div class=\"{{css}}-fourth-inner-message-container\">                         <div id=\"recorder-message-block\" class='{{css}}-message-message'>                             {{message || \"\"}}                         </div>                     </div>                 </div>             </div>         </div>     </div> </div> ","minimalist-video_recorder_topmessage":"<div id=\"recorder-topmessage-block\" class=\"{{css}}-topmessage-container\">     <div class='{{css}}-topmessage-message'>         {{topmessage}}     </div> </div>","modern-video_recorder_chooser":"<div class=\"{{css}}-chooser-container\">   <div class=\"{{css}}-chooser-button-container\">    <div class=\"{{css}}-chooser-icon-container\">    <i class=\"{{css}}-icon-{{primaryrecord ? 'videocam' : 'upload'}}\"></i>   </div>   <div>    <div id=\"chooser-primary-button\" class=\"{{css}}-chooser-primary-button\"         ba-click=\"primary()\"         ba-if=\"{{has_primary}}\">     <input id=\"file-input-opt1\" ba-if=\"{{enable_primary_select && primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\"            capture />     <input id=\"file-input-opt2\" ba-if=\"{{enable_primary_select && !primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\" />     <span>      {{primary_label}}     </span>    </div>   </div>   <div>    <div id=\"chooser-secondary-button\" class=\"{{css}}-chooser-secondary-button\"         ba-click=\"secondary()\"         ba-if=\"{{has_secondary}}\">     <input id=\"file-input-secondary-opt1\" ba-if=\"{{enable_secondary_select && secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <input id=\"file-input-secondary-opt2\" ba-if=\"{{enable_secondary_select && !secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <span>      {{secondary_label}}     </span>    </div>   </div>  </div> </div> ","space-video_recorder_controlbar":"<div class=\"{{css}}-dashboard\">   <div class=\"{{css}}-settings-front\">    <!-- Popup Settings Selections, initially hidden, appear when click button for settings -->   <div id=\"recorder-settings\" class=\"{{css}}-settings\" ba-show=\"{{settingsvisible && settingsopen}}\">    <div class=\"{{css}}-bubble-info\">     <ul id=\"camera-settings\" ba-repeat=\"{{camera :: cameras}}\">      <li>       <input type='radio' name='camera' value=\"{{selectedcamera == camera.id}}\" onclick=\"{{selectCamera(camera.id)}}\" />       <span></span>       <label onclick=\"{{selectCamera(camera.id)}}\">        {{camera.label}}       </label>      </li>     </ul>     <ul id=\"record-button-icon-cog\" ba-repeat=\"{{microphone :: microphones}}\" ba-show=\"{{audio}}\">      <li onclick=\"{{selectMicrophone(microphone.id)}}\">       <input type='radio' name='microphone' value=\"{{selectedmicrophone == microphone.id}}\" />       <span></span>       <label>        {{microphone.label}}       </label>      </li>     </ul>    </div>   </div>   </div>   <!-- Control bar, footer part which holds all buttons -->  <div id=\"controlbar\" class=\"{{css}}-controlbar\">    <div class=\"{{css}}-controlbar-center-section\">     <div id=\"rerecord-primary-button\" class=\"{{css}}-button-container\" ba-show=\"{{rerecordvisible}}\">     <div class=\"{{css}}-button-primary\"       onclick=\"{{rerecord()}}\"       onmouseenter=\"{{hover(string('rerecord-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('rerecord')}}     </div>    </div>    </div>    <div class=\"{{css}}-controlbar-left-section\" ba-show=\"{{settingsvisible}}\">              <div class=\"{{css}}-circle-button\" ba-show=\"{{settingsvisible}}\">      <div id=\"record-button-icon-cog\" class=\"{{css}}-button-inner {{css}}-button-circle-{{settingsopen ? 'selected' : 'unselected' }}\"       onclick=\"{{settingsopen=!settingsopen}}\"       onmouseenter=\"{{hover(string('settings'))}}\"       onmouseleave=\"{{unhover()}}\" >      <i class=\"{{css}}-icon-cog\"></i>     </div>     </div>     <div class=\"{{css}}-circle-button\" ba-show=\"{{!noaudio}}\">     <div id=\"record-button-icon-mic\" class=\"{{css}}-button-inner\"      onmouseenter=\"{{hover(string(microphonehealthy ? 'microphonehealthy' : 'microphoneunhealthy'))}}\"      onmouseleave=\"{{unhover()}}\">      <i class=\"{{css}}-icon-mic {{css}}-icon-state-{{minrophonehealthy ? 'good' : 'bad' }}\"></i>     </div>    </div>     <div class=\"{{css}}-circle-button\">     <div id=\"record-button-icon-videocam\" class=\"{{css}}-button-inner\"      onmouseenter=\"{{hover(string(camerahelthy ? 'camerahealthy' : 'cameraunhelathy'))}}\"      onmouseleave=\"{{unhover()}}\">                     <i class=\"{{css}}-icon-videocam {{css}}-icon-state-{{ camerahealthy ? 'good' : 'bad' }}\"></i>     </div>    </div>   </div>    <div class=\"{{css}}-controlbar-right-section\">     <div class=\"{{css}}-rightbutton-container\" ba-show=\"{{recordvisible}}\">     <div id=\"record-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{record()}}\"       onmouseenter=\"{{hover(string('record-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('record')}}     </div>    </div>    </div>    <div class=\"{{css}}-stop-container\" ba-show=\"{{stopvisible}}\">     <div class=\"{{css}}-timer-container\">     <div class=\"{{css}}-label-container\" ba-show=\"{{controlbarlabel}}\">      <div id=\"record-label-block\" class=\"{{css}}-label {{css}}-button-primary\">       {{controlbarlabel}}      </div>     </div>    </div>     <div class=\"{{css}}-stop-button-container\">     <div id=\"stop-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{stop()}}\"       onmouseenter=\"{{hover(string('stop-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('stop')}}     </div>    </div>   </div>          <div class=\"{{css}}-centerbutton-container\" ba-show=\"{{skipvisible}}\">             <div id=\"skip-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{skip()}}\"                  onmouseenter=\"{{hover(string('skip-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('skip')}}             </divi>         </div>           <div class=\"{{css}}-rightbutton-container\" ba-if=\"{{uploadcovershotvisible}}\">             <div id=\"covershot-primary-button\" class=\"{{css}}-button-primary\"                  onmouseenter=\"{{hover(string('upload-covershot-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <input type=\"file\"                        class=\"{{css}}-chooser-file\"                        style=\"height:100px\"                        onchange=\"{{uploadCovershot(domEvent)}}\"                        accept=\"{{covershot_accept_string}}\" />                 <span>                     {{string('upload-covershot')}}                 </span>             </div>         </div>   </div>  </div> ","space-video_recorder_imagegallery":"<div id=\"image-gallery\" class=\"{{css}}-image-gallery-container\">   <div id=\"slider-left-button\" class=\"{{css}}-imagegallery-leftbutton\">   <div id=\"slider-left-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{left()}}\">    <i class=\"ba-videorecorder-icon-left-open\"></i>   </div>  </div>   <div id=\"images-imagegallery-container\" ba-repeat=\"{{image::images}}\" class=\"{{css}}-imagegallery-container\" data-gallery-container>   <div class=\"{{css}}-imagegallery-image\"     ba-styles=\"{{{left: image.left + 'px', top: image.top + 'px', width: image.width + 'px', height: image.height + 'px'}}}\"     onclick=\"{{select(image)}}\">   </div>  </div>   <div id=\"slider-right-button\" class=\"{{css}}-imagegallery-rightbutton\">   <div id=\"slider-right-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{right()}}\">    <i class=\"ba-videorecorder-icon-right-open\"></i>   </div>  </div>  </div> ","space-video_recorder_loader":" <div class=\"{{css}}-loader-container\" ba-show=\"{{!label}}\">     <div id=\"recorder-loader-block\" class=\"{{css}}-loader-loader\" title=\"{{tooltip}}\">     </div> </div> <div id=\"recorder-loader-label-container\" class=\"{{css}}-loader-label\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-label-container\">         <div class=\"{{css}}-loader-countdown\">             <div id=\"recorder-loader-label\" class=\"{{css}}-button-primary\">                 {{string('starts-in')}} {{label}}             </div>         </div>         <div class=\"{{css}}-wait-button-container\">             <div id=\"recorder-loader-wait-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{freeze()}}\"                  onmouseenter=\"{{hover(string('wait-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('wait')}}             </div>         </div>     </div> </div> ","space-video_recorder_message":"<div id=\"recorder-message-container\" class=\"{{css}}-message-container\" ba-click=\"click()\">     <div class=\"{{css}}-top-inner-message-container\">         <div class=\"{{css}}-first-inner-message-container\">             <div class=\"{{css}}-second-inner-message-container\">                 <div class=\"{{css}}-third-inner-message-container\">                     <div class=\"{{css}}-fourth-inner-message-container\">                         <div id=\"recorder-message-block\" class='{{css}}-message-message'>                             {{message || \"\"}}                         </div>                     </div>                 </div>             </div>         </div>     </div> </div> ","space-video_recorder_topmessage":"<div class=\"{{css}}-topmessage-container\">     <div id=\"recorder-topmessage-block\" class='{{css}}-topmessage-message'>         {{topmessage}}     </div> </div> ","theatre-video_recorder_chooser":" <div class=\"{{css}}-chooser-container\">   <div class=\"{{css}}-chooser-button-container\">     <div class=\"{{css}}-chooser-icon-container\">    <i class=\"{{css}}-icon-{{primaryrecord ? 'videocam' : 'upload'}}\"></i>   </div>   <div>    <div class=\"{{css}}-chooser-primary-button\"         ba-click=\"primary()\"         ba-if=\"{{has_primary}}\">     <input ba-if=\"{{enable_primary_select && primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\"            capture />     <input ba-if=\"{{enable_primary_select && !primary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{primary_select(domEvent)}}\"            accept=\"{{primary_accept_string}}\" />     <span>      {{primary_label}}     </span>    </div>   </div>   <div>    <div class=\"{{css}}-chooser-secondary-button\"         ba-click=\"secondary()\"         ba-if=\"{{has_secondary}}\">     <input ba-if=\"{{enable_secondary_select && secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <input ba-if=\"{{enable_secondary_select && !secondary_select_capture}}\"            type=\"file\"            class=\"{{css}}-chooser-file\"            style=\"height:100\"            onchange=\"{{secondary_select(domEvent)}}\"            accept=\"{{secondary_accept_string}}\" />     <span>      {{secondary_label}}     </span>    </div>   </div>  </div> </div>","theatre-video_recorder_controlbar":"<div class=\"{{css}}-dashboard\">   <div class=\"{{css}}-settings-front\">    <!-- Popup Settings Selections, initially hidden, appear when click button for settings -->   <div id=\"recorder-settings\" class=\"{{css}}-settings\" ba-show=\"{{settingsvisible && settingsopen}}\">    <div class=\"{{css}}-bubble-info\">     <ul id=\"camera-settings\" ba-repeat=\"{{camera :: cameras}}\">      <li>       <input type='radio' name='camera' value=\"{{selectedcamera == camera.id}}\" onclick=\"{{selectCamera(camera.id)}}\" />       <span></span>       <label onclick=\"{{selectCamera(camera.id)}}\">        {{camera.label}}       </label>      </li>     </ul>     <ul id=\"microphone-settings\" ba-repeat=\"{{microphone :: microphones}}\" ba-show=\"{{audio}}\">      <li onclick=\"{{selectMicrophone(microphone.id)}}\">       <input type='radio' name='microphone' value=\"{{selectedmicrophone == microphone.id}}\" />       <span></span>       <label>        {{microphone.label}}       </label>      </li>     </ul>    </div>   </div>   </div>   <!-- Control bar, footer part which holds all buttons -->  <div id=\"controlbar\" class=\"{{css}}-controlbar\">    <div class=\"{{css}}-controlbar-center-section\">     <div class=\"{{css}}-button-container\" ba-show=\"{{rerecordvisible}}\">     <div id=\"rerecord-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{rerecord()}}\"       onmouseenter=\"{{hover(string('rerecord-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('rerecord')}}     </div>    </div>    </div>    <div class=\"{{css}}-controlbar-left-section\" ba-show=\"{{settingsvisible}}\">              <div class=\"{{css}}-cube-button\" ba-show=\"{{settingsvisible}}\">      <div id=\"record-button-icon-cog\" class=\"{{css}}-button-inner {{css}}-button-cube-{{settingsopen ? 'selected' : 'unselected' }}\"       onclick=\"{{settingsopen=!settingsopen}}\"       onmouseenter=\"{{hover(string('settings'))}}\"       onmouseleave=\"{{unhover()}}\" >      <i class=\"{{css}}-icon-cog\"></i>     </div>     </div>     <div class=\"{{css}}-cube-button\" ba-show=\"{{!noaudio}}\">     <div id=\"record-button-icon-mic\" class=\"{{css}}-button-inner\"      onmouseenter=\"{{hover(string(microphonehealthy ? 'microphonehealthy' : 'microphoneunhealthy'))}}\"      onmouseleave=\"{{unhover()}}\">      <i class=\"{{css}}-icon-mic {{css}}-icon-state-{{minrophonehealthy ? 'good' : 'bad' }}\"></i>     </div>    </div>     <div class=\"{{css}}-cube-button\">     <div id=\"record-button-icon-videocam\" class=\"{{css}}-button-inner\"      onmouseenter=\"{{hover(string(camerahelthy ? 'camerahealthy' : 'cameraunhelathy'))}}\"      onmouseleave=\"{{unhover()}}\">                     <i class=\"{{css}}-icon-videocam {{css}}-icon-state-{{ camerahealthy ? 'good' : 'bad' }}\"></i>     </div>    </div>   </div>    <div class=\"{{css}}-controlbar-right-section\">     <div class=\"{{css}}-rightbutton-container\" ba-show=\"{{recordvisible}}\">     <div id=\"record-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{record()}}\"       onmouseenter=\"{{hover(string('record-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('record')}}     </div>    </div>    </div>    <div class=\"{{css}}-stop-container\" ba-show=\"{{stopvisible}}\">     <div class=\"{{css}}-timer-container\">     <div class=\"{{css}}-label-container\" ba-show=\"{{controlbarlabel}}\">      <div id=\"record-label-block\" class=\"{{css}}-label {{css}}-button-primary\">       {{controlbarlabel}}      </div>     </div>    </div>     <div class=\"{{css}}-stop-button-container\">     <div id=\"stop-primary-button\" class=\"{{css}}-button-primary\"       onclick=\"{{stop()}}\"       onmouseenter=\"{{hover(string('stop-tooltip'))}}\"       onmouseleave=\"{{unhover()}}\">      {{string('stop')}}     </div>    </div>   </div>          <div class=\"{{css}}-centerbutton-container\" ba-show=\"{{skipvisible}}\">             <div id=\"skip-primary-button\" class=\"{{css}}-button-primary\"                  onclick=\"{{skip()}}\"                  onmouseenter=\"{{hover(string('skip-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('skip')}}             </div>         </div>           <div class=\"{{css}}-rightbutton-container\" ba-if=\"{{uploadcovershotvisible}}\">             <div id=\"covershot-primary-button\" class=\"{{css}}-button-primary\"                  onmouseenter=\"{{hover(string('upload-covershot-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 <input type=\"file\"                        class=\"{{css}}-chooser-file\"                        style=\"height:100px\"                        onchange=\"{{uploadCovershot(domEvent)}}\"                        accept=\"{{covershot_accept_string}}\" />                 <span>                     {{string('upload-covershot')}}                 </span>             </div>         </div>   </div>  </div> ","theatre-video_recorder_imagegallery":"<div id=\"image-gallery\" class=\"{{css}}-image-gallery-container\">   <div id=\"slider-left-button\" class=\"{{css}}-imagegallery-leftbutton\">   <div id=\"slider-left-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{left()}}\">    <i class=\"ba-videorecorder-icon-left-open\"></i>   </div>  </div>   <div id=\"images-imagegallery-container\" ba-repeat=\"{{image::images}}\" class=\"{{css}}-imagegallery-container\" data-gallery-container>   <div class=\"{{css}}-imagegallery-image\"     ba-styles=\"{{{left: image.left + 'px', top: image.top + 'px', width: image.width + 'px', height: image.height + 'px'}}}\"     onclick=\"{{select(image)}}\">   </div>  </div>   <div id=\"slider-right-button\" class=\"{{css}}-imagegallery-rightbutton\">   <div id=\"slider-right-inner-button\" class=\"{{css}}-imagegallery-button-inner\" onclick=\"{{right()}}\">    <i class=\"ba-videorecorder-icon-right-open\"></i>   </div>  </div>  </div> ","theatre-video_recorder_loader":" <div class=\"{{css}}-loader-container\" ba-show=\"{{!label}}\">     <div id=\"recorder-loader-block\" class=\"{{css}}-loader-loader\" title=\"{{tooltip}}\">     </div> </div> <div id=\"recorder-loader-label-container\" class=\"{{css}}-loader-label\" ba-show=\"{{label}}\">     <div class=\"{{css}}-loader-label-container\">         <div class=\"{{css}}-loader-countdown\">             <div id=\"recorder-loader-label\" class=\"{{css}}-button-primary\">                 {{string('starts-in')}} {{label}}             </div>         </div>         <div id=\"recorder-loader-wait-button\" class=\"{{css}}-wait-button-container\">             <div class=\"{{css}}-button-primary\"                  onclick=\"{{freeze()}}\"                  onmouseenter=\"{{hover(string('wait-tooltip'))}}\"                  onmouseleave=\"{{unhover()}}\">                 {{string('wait')}}             </div>         </div>     </div> </div> ","theatre-video_recorder_message":"<div id=\"recorder-message-container\" class=\"{{css}}-message-container\" ba-click=\"click()\">     <div class=\"{{css}}-top-inner-message-container\">         <div class=\"{{css}}-first-inner-message-container\">             <div class=\"{{css}}-second-inner-message-container\">                 <div class=\"{{css}}-third-inner-message-container\">                     <div class=\"{{css}}-fourth-inner-message-container\">                         <div id=\"recorder-message-block\" class='{{css}}-message-message'>                             {{message || \"\"}}                         </div>                     </div>                 </div>             </div>         </div>     </div> </div> "};
});
