Scoped.define("module:Common.Dynamics.Settings", [
    "base:Class",
    "base:Objs",
...
], function(Class, Objs, EventsMixin, Async, Timer, Dom, Events, Assets, scoped) {
    return Class.extend({
            scoped: scoped
        }, function(inherited) {
            return {

                template: "<%= template(dirname + '/settings.html') %>",
                ...
                functions: {
                    ...
                    trigger_option: function(id, value) {}
                },
        ...
        .register("ba-settings-menu")
        .registerFunctions({
            /*<%= template_function_cache(dirname + '/settings.html') %>*/
        })
