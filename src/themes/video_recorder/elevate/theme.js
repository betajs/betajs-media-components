Scoped.extend("module:Assets.recorderthemes", [
    ...
    Parser.registerFunctions({
        /*<%= template_function_cache(dirname + '/elevate-video_recorder_topmessage.html') %>*/
    });
    Parser.registerFunctions({
        /*<%= template_function_cache(dirname + '/elevate-video_recorder_controlbar.html') %>*/
    });
    Parser.registerFunctions({
    ...
    return {
        "elevate": {
            ...
            csstheme: "ba-recorder-theme-elevate",
