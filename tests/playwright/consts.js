...
export const CHROME_LOCATION = process.env.PLAYWRIGHT_CHROMIUM_EXECUTABLE_PATH || `/Applications/Google Chrome.app/Contents/MacOS/Google Chrome`;
export const CHROME_CANARY_LOCATION = process.env.CHROME_CANARY_LOCATION || `/Applications/Google Chrome Canary.app/Contents/MacOS/Google Chrome Canary`;
